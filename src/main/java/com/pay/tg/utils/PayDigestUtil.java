...
public class PayDigestUtil {
    ...
    private final static Logger _log = LoggerFactory.getLogger(PayDigestUtil.class);
    ...
    public static String getSign(String params) {
        _log.debug("Sign Before MD5:" + params);
        String result = md5(params, encodingCharset).toUpperCase();
        _log.debug("Sign Result:" + result);
        return result;
    }
    ...
    public static String getSign(Map<String, Object> map, String key, String... notContains) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            for (String notContain : notContains) {
                if (entry.getKey().equals(notContain)) {
                    isContain = true;
                    break;
                }
            }
